...
class PaymentView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.success(self.request, "Tu compra fue exitosa!")
            return redirect("/")
...
class OrderSummaryView(LoginRequiredMixin, View):
    def get(self, *args, **kwargs):
        try:
            ...
            messages.warning(self.request, "No tienes ningun producto agregado al carrito de compras")
            return redirect("/")
...
def add_to_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        if order.items.filter(item__slug=item.slug).exists():
            ...
            messages.info(request, "Este producto fue añadido a tu carrito de compras.")
            return redirect("ecommerce:order-summary")
    else:
...
class PurchasesView(LoginRequiredMixin, ListView):
    template_name = 'ecommerce/purchases.html'
